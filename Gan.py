...
# Arguments
architecture = ['trans_trans', 'lstm_cnn', 'rmc_vanilla', 'rmc_vanilla', 'rmc_vanilla', 'rmc_vanilla', 'rmc_vanilla', 'rmc_vanilla']
...
hidden_dim = '23'
seq_len = '32'
dataset = 'amazon_food8.12_len30_styleword'
...
args = [
    ...
    '--gf-dim', '64',
    '--df-dim', '64',
    '--g_architecture', architecture[job_id],
    '--d_architecture', architecture[job_id],
    ...
    '--save-dir', os.path.join(outdir, 'save'),
    ...
    # dataset
    '--dataset', dataset,
    # '--vocab-size', '9361',  # yelp
    # '--vocab-size', '12454',  #amazon_food_15
    '--vocab-size', '22961',  #amazon_food_30
    # '--vocab-size', '13437',  #IMDB
    '--start-token', '0',
    '--seq-len', seq_len,
