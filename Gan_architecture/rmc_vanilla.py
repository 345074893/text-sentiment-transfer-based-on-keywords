...
from Gan_architecture.model.relational_memory import RelationalMemory
from tensorflow.python.ops import tensor_array_ops, control_flow_ops
from utils.ops import *


# The generator network based on the Relational Memory
def generator(x_real, text_keyword_id, text_keyword_length, labels, text_length, temperature, vocab_size, batch_size, seq_len, gen_emb_dim, mem_slots, head_size, num_heads,
